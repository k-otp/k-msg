import { AlimTalkProvider, AlimTalkRequest, AlimTalkResult, ProviderCapabilities, TemplateContract, ChannelContract, MessagingContract, AnalyticsContract, AccountContract, ProviderConfiguration } from '../contracts/provider.contract';
