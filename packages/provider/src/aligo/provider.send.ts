...
export class AligoSendProvider implements Provider, KakaoChannelProvider {
  readonly id = "aligo";
...
export const createAligoSendProvider = (config: AligoConfig) =>
  new AligoSendProvider(config);

export const createDefaultAligoSendProvider = () => {
