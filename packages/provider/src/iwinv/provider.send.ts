...
function normalizeIwinvConfig(config: IWINVConfig): NormalizedIwinvConfig {
  return {
    ...config,
...
export const createIWINVSendProvider = (config: IWINVConfig) =>
  new IWINVSendProvider(config);
