...
import { ok, fail, KMsgError, KMsgErrorCode, Provider, SendOptions } from '@k-msg/core';
...
describe('KMsg', () => {
  test('should send a message and call hooks', async () => {
    ...
    (options as unknown as Record<string, unknown>).variables = { name: 'World' };
    ...
    const sentOptions = sendMock.mock.calls[0][0] as unknown as Record<string, unknown>;
