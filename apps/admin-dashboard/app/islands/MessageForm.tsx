        ...
        <form onSubmit={handleSubmit} class="space-y-4">
          <div>
            ...
            <input 
              ...
              onInput={(e) => setMessage({ ...message, templateId: e.currentTarget.value })}
              required
          ...
          <div>
            ...
            <input 
              ...
              onInput={(e) => setMessage({ ...message, phoneNumber: e.currentTarget.value })}
              required
              pattern="[0-9]{10,11}"
          ...
          <div>
            ...
            <textarea 
              ...
              onInput={(e) => setMessage({ ...message, variables: e.currentTarget.value })}
              rows={3}
