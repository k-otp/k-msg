...
next: false
prev: false
title: "KeySetStateProvider"
---

Defined in: [packages/core/src/crypto/key-resolver.ts:13](https://github.com/k-otp/k-msg/blob/main/packages/core/src/crypto/key-resolver.ts#L13)
