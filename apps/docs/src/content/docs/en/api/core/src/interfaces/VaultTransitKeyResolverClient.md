...
next: false
prev: false
title: "VaultTransitKeyResolverClient"
---

Defined in: [packages/core/src/crypto/key-adapters/vault-transit.ts:7](https://github.com/k-otp/k-msg/blob/main/packages/core/src/crypto/key-adapters/vault-transit.ts#L7)
