...
next: false
prev: false
title: "FieldCryptoErrorMetadata"
---

Defined in: [packages/core/src/crypto/errors.ts:26](https://github.com/k-otp/k-msg/blob/main/packages/core/src/crypto/errors.ts#L26)
