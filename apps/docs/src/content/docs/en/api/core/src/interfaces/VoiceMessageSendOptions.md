...
> `optional` **voice**: [`VoiceSendOptions`](/en/api/core/src/interfaces/voicesendoptions/)

Defined in: [packages/core/src/types/message.ts:301](https://github.com/k-otp/k-msg/blob/main/packages/core/src/types/message.ts#L301)
