...
next: false
prev: false
title: "AwsKmsKeyResolverOptions"
---

Defined in: [packages/core/src/crypto/key-adapters/aws-kms.ts:16](https://github.com/k-otp/k-msg/blob/main/packages/core/src/crypto/key-adapters/aws-kms.ts#L16)
