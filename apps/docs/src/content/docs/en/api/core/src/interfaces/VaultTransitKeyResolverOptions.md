...
next: false
prev: false
title: "VaultTransitKeyResolverOptions"
---

Defined in: [packages/core/src/crypto/key-adapters/vault-transit.ts:17](https://github.com/k-otp/k-msg/blob/main/packages/core/src/crypto/key-adapters/vault-transit.ts#L17)
