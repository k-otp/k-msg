...
Defined in: [packages/messaging/src/types/message.types.ts:275](https://github.com/k-otp/k-msg/blob/main/packages/messaging/src/types/message.types.ts#L275)
