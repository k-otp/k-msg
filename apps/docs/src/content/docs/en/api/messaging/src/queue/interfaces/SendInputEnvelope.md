...
next: false
prev: false
title: "SendInputEnvelope"
---

Defined in: [packages/messaging/src/queue/send-input.builder.ts:25](https://github.com/k-otp/k-msg/blob/main/packages/messaging/src/queue/send-input.builder.ts#L25)
