...
next: false
prev: false
title: "BuildSendInputOptions"
---

Defined in: [packages/messaging/src/queue/send-input.builder.ts:21](https://github.com/k-otp/k-msg/blob/main/packages/messaging/src/queue/send-input.builder.ts#L21)
