...
[`PermissionCheck`](/api/channel/src/interfaces/permissioncheck/)

#### Returns

`Promise`\<[`PermissionResult`](/api/channel/src/interfaces/permissionresult/)\>
...
`Omit`\<[`Role`](/api/channel/src/interfaces/role/), `"id"` \| `"createdAt"` \| `"updatedAt"`\>

#### Returns

`Promise`\<[`Role`](/api/channel/src/interfaces/role/)\>
...
`Omit`\<[`User`](/api/channel/src/interfaces/user/), `"id"` \| `"createdAt"` \| `"updatedAt"`\>

#### Returns

`Promise`\<[`User`](/api/channel/src/interfaces/user/)\>
...
`Promise`\<[`Role`](/api/channel/src/interfaces/role/) \| `null`\>
...
`Promise`\<[`User`](/api/channel/src/interfaces/user/) \| `null`\>
...
`Promise`\<[`Permission`](/api/channel/src/interfaces/permission/)[]\>
...
[`ResourceType`](/api/channel/src/enumerations/resourcetype/)

##### action

[`ActionType`](/api/channel/src/enumerations/actiontype/)
...
[`AccessContext`](/api/channel/src/interfaces/accesscontext/)
...
[`Role`](/api/channel/src/interfaces/role/)[]
...
[`User`](/api/channel/src/interfaces/user/)[]
...
`Partial`\<[`Role`](/api/channel/src/interfaces/role/)\>
...
`Partial`\<[`User`](/api/channel/src/interfaces/user/)\>
