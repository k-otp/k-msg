...
`Partial`\<[`BusinessVerifierOptions`](/api/channel/src/interfaces/businessverifieroptions/)\> = `{}`
...
[`VerificationDocument`](/api/channel/src/interfaces/verificationdocument/)

#### Returns

`Promise`\<[`VerificationRequest`](/api/channel/src/interfaces/verificationrequest/)\>
...
[`VerificationRequest`](/api/channel/src/interfaces/verificationrequest/) \| `null`
...
[`VerificationStatus`](/api/channel/src/enumerations/verificationstatus/)
...
[`VerificationRequest`](/api/channel/src/interfaces/verificationrequest/)[]
...
[`BusinessInfo`](/api/channel/src/interfaces/businessinfo/)
