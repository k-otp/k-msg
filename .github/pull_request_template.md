...
<!-- Mark all packages that are modified by this PR -->
...
- [ ] Examples updated if needed
- [ ] docs:check passed locally (`bun run docs:check`) when changing `packages/*`, `apps/cli/*`, `examples/*`, `apps/docs/*`, `apps/docs-hono/*`, or `scripts/docs/*`

#### Dependencies

- [ ] No unnecessary dependencies added
- [ ] Dependencies are compatible with project requirements
- [ ] Package versions are properly constrained
